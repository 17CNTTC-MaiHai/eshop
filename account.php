<?php
    ...
    if(isset($_POST['click'])){
        $tbErr = "Sửa thông tin thanh cong";
        $name = $_POST["name"];
        $email = $_POST["email"];
        $password = $_POST["pass"];
        $img = $_POST["image"];
        ...
        // $sql = "UPDATE `playerss` SET `name`='$name',`age`='$age',`national`='$quoctich',`position`='$vitri',`salary`='$luong' 
        // WHERE `id` = '$id'";
        $sql = "UPDATE `register` SET `name`='$name',`email`='$email',`password`='$password',`image`='$img' WHERE `email` = '$email'";
				...
				<div class="col-sm-7 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="" method="POST">
                            ...
                            <input type="password"  name="pass" value="<?php echo $data[0]['password'] ?>">
                            <span class="error"><?php echo $qtErr; ?></span>

                            <input type="file" name="avatar" value="<?php echo $data[0]['image'] ?>"/>
