					...
					<div class="features_items"><!--features_items-->
										...
										<div class="product-overlay">
											<div class="overlay-content">
												...
												<form method="post">
													...
													<button type="submit" name="submit_a" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart999</button>
												</form>
											</div>
										</div>
								</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="/imgProduct/<?php echo $value['image'] ?>" alt="" />
									...
									<div class="product-overlay">
										...
										<div class="overlay-content">
											...
											<form method="post">
												...
												<input type="hidden" name="img" value="/imgProduct/<?php echo $value['image'] ?>">
												<input type="hidden" name="title" value="<?php echo $value['title']?>">
	
												<a id="<?php echo $value['id'] ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</form>
										</div>
									</div>
									<img src="images/home/new.png" class="new" alt="" />
